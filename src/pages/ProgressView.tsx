...
export function ProgressView() {
  ...
  const trendData = useMemo(() => {
    ...
    const firstAvg = (Object.values(first.scores) as number[]).reduce((a, b) => a + b, 0) / Object.values(first.scores).length;
    const lastAvg = (Object.values(last.scores) as number[]).reduce((a, b) => a + b, 0) / Object.values(last.scores).length;
    return {
  ...
  const chartData = useMemo(() => {
    return studentEvals.map(ev => {
      const avg = (Object.values(ev.scores) as number[]).reduce((a, b) => a + b, 0) / Object.values(ev.scores).length;
      return {
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {evals.map(ev => {
                        const avg = ((Object.values(ev.scores) as number[]).reduce((a, b) => a + b, 0) / Object.values(ev.scores).length).toFixed(1);
                        return (
